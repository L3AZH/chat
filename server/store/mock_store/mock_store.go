...
import (
	...
	auth "github.com/l3azh/chat/server/auth"
	adapter "github.com/l3azh/chat/server/db"
	media "github.com/l3azh/chat/server/media"
	types "github.com/l3azh/chat/server/store/types"
	validate "github.com/l3azh/chat/server/validate"
)
